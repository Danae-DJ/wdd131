...
const bicycles = [
    {
        ...
        description: "Lightweight with narrow tires and drop handlebars.",
                    "Best for paved roads and speed.",
                    "Ideal for endurance riding, racing, or fitness.",
...

    {
        ...
        description: "Sturdy frame, wide tires, and suspension (front, rear, or both).",
                    "Designed for off-road trails and rough terrain.",
                    "Variants: Cross-country, trail, downhill, and enduro bikes.",
...

    {
        ...
        description: "Blend of road and mountain bike features.",
                    "Comfortable upright position, suitable for commuting and light off-road trails.",
...

    {
        ...
        description: "Drop handlebars like a road bike but wider tires for unpaved roads.",
                    "Versatile for mixed surfaces and adventure riding.",
...

    {
        ...
        description: "Compact and durable for stunts, tricks, and racing.",
                    "Single-speed with small wheels and high maneuverability.",
...

    {
        ...
        description: "Fixed gear with no brakes.",
                    "Designed for velodrome racing.",
...

    {
        ...
        description: "Built for long distances with racks for carrying gear.",
                    "Sturdy and comfortable for multi-day rides.",
...

    {
        ...
        description: "Equipped with a motor to assist pedaling.",
                    "Suitable for commuting, recreation, or mountain biking.",
...

    {
        ...
        description: "Oversized tires for sand, snow, or loose terrain.",
